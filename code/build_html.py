...
「AI 기반 공공데이터 분석」 웹교재 빌더를 행정사 교재(3부·13주·1/2차시)용으로 각색.
...
nav.sidebar .t1 { background:#f3ecdd; color:#8a6d3b; }
...
main div[style] { font-size:1.15rem; font-size:clamp(1.02rem, 2.2cqw, 1.45rem);
  line-height:1.72; padding:6px 10px !important; margin:12px 0 !important; }
main div[style] strong { font-size:1.03em; }
...
toc_html = [
    ...
    "행정학의 고전 텍스트를 직접 읽으며 행정과 행정학의 역사적 전개를 탐구하는 "
    "학부 수준의 강의 교재입니다. 13개 주차가 각각 1차시와 2차시로 나뉘며, "
    "공자와 키케로에서 벤담, 윌슨, 테일러, 베버, 사이먼, 왈도, 린드블롬, 프레드릭슨까지 "
